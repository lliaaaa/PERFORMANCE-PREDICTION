...
<div style="margin-top: 3%">
    <h3 class="mb-4 text-center">Select a Course to View</h3> <!-- Centered heading -->
</div>
<div class="container d-flex align-items-center justify-content-center full-height"> <!-- Centering container -->
    <div>
        <div class="btn-group-vertical" role="group" aria-label="Course selection">
            <?php foreach ($courses as $course): ?>
                <button class="btn btn-red" onclick="location.href='index.php?page=grades&course=<?= urlencode($course) ?>'">
